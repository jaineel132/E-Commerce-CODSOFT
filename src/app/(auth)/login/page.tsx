        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-muted px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted/80 transition-colors"
            >
              Google
            </button>
          </div>
