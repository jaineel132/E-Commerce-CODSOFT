...
const StatCard = memo(function StatCard({ label, value, icon: Icon, colorBase }: { label: string; value: string; icon: LucideIcon; colorBase: ColorBase }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card p-6 shadow-sm ring-1 ring-inset ring-border/10 transition-all hover:shadow-md">
    ...
    <Skeleton name="admin-dashboard" loading={loading}>
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-border/50 bg-card p-6 shadow-sm ring-1 ring-inset ring-border/10">
