...
export const ProductCard = memo(function ProductCard({ product, priority, ratingStats }: ProductCardProps) {
  ...
  return (
    <motion.div 
      ...
      className="group relative flex flex-col overflow-hidden rounded-3xl bg-card text-card-foreground shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="mb-3 flex items-center justify-between">
          <div className="inline-flex items-center rounded-full bg-muted px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-foreground">
            ...
            <button
              ...
              className={`flex w-full items-center justify-center gap-2 rounded-full px-4 py-3 text-[14px] font-bold transition-all duration-300 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 ${
                added
                  ...
                  : 'bg-primary text-primary-foreground shadow-md hover:shadow-xl hover:bg-primary-hover'
              }`}
            >
              {added ? (
                <>
