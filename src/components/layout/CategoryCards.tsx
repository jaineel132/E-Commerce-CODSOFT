...
const styles = [
  { bg: 'bg-[#1e1e1e]', text: 'text-white', button: 'bg-[#ef4444] text-white hover:bg-red-700', icon: Headphones },
  { bg: 'bg-[#facc15]', text: 'text-black', button: 'bg-white/90 text-black hover:bg-white', icon: Watch },
  { bg: 'bg-[#ef4444]', text: 'text-white', button: 'bg-white/90 text-red-600 hover:bg-white', icon: Laptop },
  { bg: 'bg-[#e5e7eb]', text: 'text-black', button: 'bg-[#ef4444] text-white hover:bg-red-700', icon: Gamepad2 },
  { bg: 'bg-[#22c55e]', text: 'text-white', button: 'bg-white/90 text-green-600 hover:bg-white', icon: Monitor },
  { bg: 'bg-[#3b82f6]', text: 'text-white', button: 'bg-white/90 text-blue-600 hover:bg-white', icon: Speaker },
]
    ...
    <section className="bg-background py-16">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 py-8 border-t border-border">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 text-sm font-bold text-black dark:text-white">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-normal text-gray-500">Free Shipping On All Order</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center h-10 w-10 rounded-full bg-red-100 text-red-600">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-normal text-gray-500">30 Day Money Back</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center h-10 w-10 rounded-full bg-red-100 text-red-600">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-normal text-gray-500">Technical Support 24/7</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center h-10 w-10 rounded-full bg-red-100 text-red-600">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-normal text-gray-500">All Cards Accepted</span>
              </div>
            </div>
          </div>
        </div>
