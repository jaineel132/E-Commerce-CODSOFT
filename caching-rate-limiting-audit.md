...
| 3 | Phase 3 | Add `unstable_cache` to product GET routes, add `revalidateTag` to mutations | Phase 1 (shares Redis if using Upstash for cache too) | ✅ Done |
| 4 | Phase 2 | Add search result caching using Upstash Redis | Phase 1 Redis instance | ✅ Done |
